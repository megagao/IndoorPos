...
public class DoGroup {
	...
	/**
	 * @description: 根据传进来的基站列表，将基站进行分组，得到每个基站rssi的去除极端值的均值所组成的列表
	 *
	...
	/**
	 * 
	 * @description: 根据传进来的基站列表，将基站进行分组
	 *
	...
	/**
	 * 
	 * @description: 把根据id分组后的Map进行处理，得到每个id组中去掉首尾极端值的rssi均值，若某组的rssi值个数小于4，
